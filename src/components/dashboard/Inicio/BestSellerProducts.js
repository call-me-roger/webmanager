...
function createData(product, quantity, price) {
  ...
  counter += 1;
  return { id: counter, product, quantity, price, subtotal };
}
...
class BestSellerProducts extends React.Component {
  state = {
    order: "desc",
    orderBy: "quantity",
    selected: [],
    data: [
      createData("Pão de Queijo", 150, 1.2),
      createData("Sanduiche Natural", 95, 5),
      createData("Bolo de Chocolate", 60, 8),
      createData("Lasanha de Frango", 54, 12.0)
    ],
    page: 0,
    rowsPerPage: 5
  };
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell numeric>{n.subtotal.toFixed(2)}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
...
export default withStyles(styles)(BestSellerProducts);
